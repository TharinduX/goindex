...
<div class="mdui-container-fluid">
	...
	<div class="mdui-textfield">
	  ...
	  <input class="mdui-textfield-input mdui-text-color-white-secondary" type="text" value="${url}"/>
	</div>
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label mdui-text-color-white-text">HTML Reference address</label>
	  <textarea class="mdui-textfield-input mdui-text-color-white-secondary"><video><source src="${url}" type="video/mp4"></video></textarea>
	</div>
</div>
